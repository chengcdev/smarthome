...
public class ResetActivity extends K3BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FragmentUtils.replace(this, R.id.fl_container, getFragment(0));
        mCurrent = 0;
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        FragmentUtils.replace(this, R.id.fl_container, getFragment(0));
        FragmentUtils.replace(this, R.id.fl_container, getFragment(1), true);
        mCurrent = 1;
    }
    ...
    public void gotoNextFragment() {
        if (mCurrent >= 4) {
            ...
            if (fragment != null) {
                FragmentUtils.replace(this, R.id.fl_container, fragment, true);
                mCurrent = next;
            }
        }
    }
