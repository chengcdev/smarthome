 ...
 * 网络设置
 */
public class SetNetworkFragment extends BaseSetFragment {
    ...
    protected void bindData() {
        ...
        if (deviceType == CommTypeDef.DeviceType.DEVICE_TYPE_STAIR) {
            int newLen = vwList.length + 1;
            vwList = Arrays.copyOf(vwList, newLen, View[].class);
            vwList[newLen - 1] = vgElevator;
        }
