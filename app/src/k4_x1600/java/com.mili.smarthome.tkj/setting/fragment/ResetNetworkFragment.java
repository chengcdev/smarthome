...
public class ResetNetworkFragment extends ResetBaseFragment implements View.OnClickListener, View.OnTouchListener {
    ...
    private View llPage1, llPage2, llPage3;
    ...
    protected void bindView() {
        ...
        tvFace = findView(R.id.tv_face_server);
        ...
        tvFace.setOnTouchListener(this);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch(view.getId()) {
            ...
            case R.id.tv_elevator_ip:
                ...
                break;
            case R.id.tv_face_server:
                tvFace.requestFocus();
                tvFace.setCursorIndex(0);
                break;
        }
        return false;
    }
