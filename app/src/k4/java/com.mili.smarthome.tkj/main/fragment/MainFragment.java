...
public class MainFragment extends K4BaseFragment implements FreeObservable.FreeObserver {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LogUtils.d(TAG + "[onViewCreated] devDesc is " + mDevDesc);
    }
    ...
    public boolean onFreeReport(long freeTime) {
        if (AppConfig.getInstance().getBodyInduction() == 1) {
            if (freeTime / 1000 == 10) {
                LogUtils.d(TAG + "[onFreeReport] start screen saver.");
