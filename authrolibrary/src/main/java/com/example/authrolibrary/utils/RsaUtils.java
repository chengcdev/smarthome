...
public class RsaUtils {
    ...
    public static void genKeyPair() throws NoSuchAlgorithmException {
        ...
        // 得到公钥
        String publicKeyString = new String(Base64Util.encodeBase64(publicKey.getEncoded()));
        // 得到私钥字符串
        String privateKeyString = new String(Base64Util.encodeBase64((privateKey.getEncoded())));
        // 将公钥和私钥保存到Map
        //0表示公钥
    ...
    public static String encrypt( String str, String publicKey ) throws Exception{
        ...
        String outStr = Base64Util.encodeBase64(cipher.doFinal(str.getBytes("UTF-8")));
        return outStr;
    }
...
//        byte[] decoded = Base64.decode(publicKey.getBytes("UTF-8"), Base64.DEFAULT);
        ...
        byte[] inputByte = Base64Util.decodeBase64(str);
        //base64编码的私钥
        byte[] decoded = Base64Util.decodeBase64(publicKey);
        RSAPublicKey pubKey = (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(decoded));
        //RSA解密
